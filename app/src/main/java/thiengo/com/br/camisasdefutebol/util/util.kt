...
/*
 * Simulador de código de compra realizada. O "+ 1000000000"
 * é necessário, pois Random().nextInt(1000000000) pode gerar
 * qualquer valor entre 0 e 999999999. Com o "+ 1000000000"
 * garantimos os 8 digitos de código de compra.
 * */
fun orderCodeGenerator(): String{
    val code = Random().nextInt(1000000000) + 1000000000
